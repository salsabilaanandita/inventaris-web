        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-header bg-transparent border-0 p-4 border-bottom">
                    <h5 class="fw-bold mb-1">Edit Pelanggan</h5>
                    <p class="text-muted small mb-0">Perbarui data pelanggan di sistem.</p>
                </div>
                    ...
                    <form action="{{ route('customers.update', $customer->id) }}" method="POST">
                        ...
                        <div class="row g-4">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $customer->name) }}" placeholder="Contoh: Budi Santoso" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="phone" class="form-control border-start-0 ps-0 @error('phone') is-invalid @enderror" value="{{ old('phone', $customer->phone) }}" placeholder="Contoh: 08123456789">
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email" class="form-control border-start-0 ps-0 @error('email') is-invalid @enderror" value="{{ old('email', $customer->email) }}" placeholder="Contoh: budi@email.com">
                                </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="address" class="form-control @error('address') is-invalid @enderror" rows="3" placeholder="Detail alamat pelanggan (opsional)">{{ old('address', $customer->address) }}</textarea>
