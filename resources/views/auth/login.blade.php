...
<head>
    ...
    <title>Log in to your Account - InventarisPro</title>
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4 mt-3">
                    <div class="form-check d-flex align-items-center gap-2 m-0 p-0">
                        <input class="custom-check-input" type="checkbox" id="remember">
                        <label class="form-check-label small" for="remember" style="cursor:pointer; font-weight: 500; color: var(--muted);">
                            Remember me
                        </label>
                    </div>
                    <a href="#" class="text-decoration-none small" style="color: var(--accent); font-weight: 600;">Forgot Password?</a>
                </div>
                ...
                <div class="text-center mt-4">
                    <p class="small mb-0" style="color: var(--muted);">Don't have an account? 
                        <a href="{{ route('register') }}" class="text-decoration-none" style="color: var(--accent); font-weight: 600;">Create an account</a>
                    </p>
                </div>
            </form>
        </div>
