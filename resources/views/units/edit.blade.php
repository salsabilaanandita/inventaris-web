        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-header bg-transparent border-0 p-4 border-bottom">
                    <h5 class="fw-bold mb-1">Edit Satuan</h5>
                    <p class="text-muted small mb-0">Perbarui informasi satuan barang inventaris.</p>
                </div>
                    ...
                    <form action="{{ route('units.update', $unit) }}" method="POST">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $unit->name) }}" placeholder="Contoh: Pieces" required>
                                @error('name')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="symbol" class="form-control @error('symbol') is-invalid @enderror" value="{{ old('symbol', $unit->symbol) }}" placeholder="Contoh: pcs" required>
                                @error('symbol')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
