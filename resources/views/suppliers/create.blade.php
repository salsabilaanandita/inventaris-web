        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-header bg-transparent border-0 p-4 border-bottom">
                    <h5 class="fw-bold mb-1">Tambah Supplier</h5>
                    <p class="text-muted small mb-0">Tambahkan data supplier atau pemasok barang baru.</p>
                </div>
                    ...
                    <form action="{{ route('suppliers.store') }}" method="POST">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Contoh: PT. Abadi Jaya" required>
                                @error('name')
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="address" class="form-control @error('address') is-invalid @enderror" rows="4" placeholder="Detail alamat perusahaan (opsional)">{{ old('address') }}</textarea>
                                @error('address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
