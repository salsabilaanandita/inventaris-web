        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-header bg-transparent border-0 p-4 border-bottom">
                    ...
                    <p class="text-muted small mb-0">Perbarui informasi kategori barang inventaris.</p>
                </div>
                    ...
                    <form action="{{ route('categories.update', $category->id) }}" method="POST">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $category->name) }}" placeholder="Contoh: Alat Dapur">
                                @error('name')
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="division_pj" class="form-select @error('division_pj') is-invalid @enderror">
                                    <option value="" disabled>Pilih Divisi PJ...</option>
                                    ...
                                    <option value="Tefa" {{ old('division_pj', strtolower($category->division_pj)) == 'tefa' || old('division_pj', $category->division_pj) == 'Tefa' ? 'selected' : '' }}>Tefa</option>
                                </select>
                                @error('division_pj')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
